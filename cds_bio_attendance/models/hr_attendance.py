...
class HrAttendance(models.Model):
    ...
    emp_logs_ids = fields.Many2many(comodel_name="biometric.log", string="Logs", )
    machine_in = fields.Many2one('biometric.machine', 'Check in Machine')
    machine_out = fields.Many2one('biometric.machine', 'Check out Machine')
