...
class non_conformance_report_log_details(models.Model):
    ...
    third_roll_action = fields.Selection([('done','Done'),('notdone','Not Done')],'Third Roll Action ', track_visibility='always')
    ...
    fourth_roll_action = fields.Selection([('done', 'Done'), ('notdone', 'Not Done')], 'Fourth Roll Action ',track_visibility='always')
