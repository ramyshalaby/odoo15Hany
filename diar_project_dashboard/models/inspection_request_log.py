...
class inspection_request_log_details(models.Model):
    ...
    irStatus = fields.Selection([('opened', 'Opened'), ('closed', 'Closed')], 'IR Status', track_visibility='always',compute="onchange_code_dos")
    ...
    @api.depends('action_code', 'ir_latest_super')
