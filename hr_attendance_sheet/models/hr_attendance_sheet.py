...
class AttendanceSheet(models.Model):
    ...
    def _get_report_base_filename(self):
        return  "Attendance Sheet For:" + str(self.employee_id.name) +" From :"+ str(self.date_from) +" To : "+str(self.date_to)
    ...
    company_id = fields.Many2one(comodel_name="res.company", default=lambda self: self.env.user.company_id.id , required=True)
