...
class AttendanceDevice(models.Model):
    ...
    def disconnect(self):
        try:
            return self._set_zk().disconnect()
        except Exception as e:
            _logger.error(e)
    ...
    def disableDevice(self):
        ...
        """
        try:
            return self._set_zk().disable_device()
        except Exception as e:
            _logger.error(e)
    ...
    def enableDevice(self):
        ...
        """
        try:
            return self._set_zk().enable_device()
        except Exception as e:
            _logger.error(e)
    ...
    def getFirmwareVersion(self):
        ...
        try:
            self.connect()
            self.enableDevice()
            return self._set_zk().get_firmware_version()
        except Exception as e:
            _logger.error(e)
    ...
    def getSerialNumber(self):
        ...
        try:
            self.connect()
            self.enableDevice()
            return self._set_zk().get_serialnumber()
        except Exception as e:
            _logger.error(e)
            raise ValidationError(
    ...
    def getOEMVendor(self):
        ...
        try:
            self.connect()
            self.enableDevice()
            return self._set_zk().get_oem_vendor()
        except Exception as e:
            _logger.error(e)
            raise ValidationError(
    ...
    def getFingerprintAlgorithm(self):
        ...
        try:
            self.connect()
            self.enableDevice()
            return self._set_zk().get_fp_version()
        except Exception as e:
            _logger.error(e)
            raise ValidationError(
    ...
    def getPlatform(self):
        ...
        try:
            self.connect()
            self.enableDevice()
            return self._set_zk().get_platform()
        except Exception as e:
            _logger.error(e)
            raise ValidationError(
    ...
    def getDeviceName(self):
        ...
        try:
            self.connect()
            self.enableDevice()
            return self._set_zk().get_device_name()
        except Exception as e:
            _logger.error(e)
    ...
    def getWorkCode(self):
        ...
        try:
            self.connect()
            self.enableDevice()
            return self._set_zk().get_workcode()
        except Exception as e:
            _logger.error(e)
            raise ValidationError(
    ...
    def setUser(self, uid=None, name='', privilege=0, password='', group_id='', user_id='', card=0):
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self._set_zk().set_user(uid, name, privilege, password, group_id, user_id, card)
        except Exception as e:
            _logger.info(e)
    ...
    def delUser(self, uid, user_id):
        ...
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self._set_zk().delete_user(uid, user_id)
        except Exception as e:
            _logger.error(e)
    ...
    def action_clear_data(self):
        ...
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self._set_zk().clear_data()
        except Exception as e:
            _logger.error(e)
    ...
    def upload_finger_templates(self, uid, name, privilege, password, group_id, user_id, fingers):
        ...
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self._set_zk().save_user_template(user, fingers)
        except Exception as e:
            _logger.error(e)
    ...
    def delFingerTemplate(self, uid, fid, user_id):
        ...
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self._set_zk().delete_user_template(uid, fid, user_id)
        except Exception as e:
            _logger.error(e)
    ...
    def getFingerTemplate(self):
        ...
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self._set_zk().get_templates()
        except Exception as e:
            _logger.error(str(e))
    ...
    def get_next_uid(self):
        ...
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self._set_zk().get_next_uid()
        except Exception as e:
            _logger.error(str(e))
    ...
    def getAttendance(self):
        ...
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self._set_zk().get_attendance()
    ...
    def clearAttendance(self):
        ...
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self._set_zk().clear_attendance()
        except Exception:
            raise ValidationError(_('Could not get attendance data from the device %s') % (self.display_name,))
        finally:
            self.enableDevice()
            ...
            for attendance in attendance_data:
                ...
                if user_id:
                    ...
                    duplicate_attend = DeviceUserAttendance.search([
                        ('device_id', '=', r.id),
                        ('user_id', '=', user_id.id),
                        ('timestamp', '=', utc_timestamp- timedelta(hours=2))], limit=1)
                    # for r in utc_timestamp:
                    print("hoursss", utc_timestamp.hour)
                    # utc_timestamp=utc_timestamp
                    # if utc_timestamp.hour>2:
                    #    utc_timestamp=utc_timestamp.replace(hour = utc_timestamp.hour-2)
                    # elif utc_timestamp.hour==22 and utc_timestamp.day<30:
                    #     utc_timestamp = utc_timestamp.replace(hour=0, day=utc_timestamp.day+1)
                    # elif utc_timestamp.hour == 23 and utc_timestamp.day < 30:
                    #     utc_timestamp = utc_timestamp.replace(hour=1, day=utc_timestamp.day + 1)
                    # # elif utc_timestamp.hour == 24 and utc_timestamp.day < 30:
                    # #     utc_timestamp = utc_timestamp.replace(hour=1, day=utc_timestamp.day + 1)
                    ...
                    if not duplicate_attend:
                        try:
                            ...
                            vals = {
                                'device_id': r.id,
                                'user_id': user_id.id,
                                'timestamp': utc_timestamp- timedelta(hours=2),
